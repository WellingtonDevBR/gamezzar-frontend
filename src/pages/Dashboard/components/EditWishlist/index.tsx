            ...
            <Main>
              ...
              <div>
                ...
                <Section>
                  <h3>Preferences</h3>
                  <p>
                    How would you describe your willingness to trade this game?
                  </p>
                  <Controller
                    control={control}
                    name="interest_level"
                    rules={{ required: true }}
                    defaultValue={wishlist?.interest_level} // Provide a default value
                    render={({ field }) => (
                      <Select {...field}>
                        ...
                        <option value="gauge2.svg">
                          I'll only trade it for a game of little importance to
                          me
                        </option>
